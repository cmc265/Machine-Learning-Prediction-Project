...
# Finally, we remove predictors which intuitively will not correlate with te outcome such as the name , time of day etc.
# This leaves us with the following list of better predictors
...
# Output of the model shows a 49% accuracy - see below:
...
# Try now the random forest methodlogy to predict the class outcome (classe)
